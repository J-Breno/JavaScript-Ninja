   ...
   $inputUsername.value = username;
    ...
    - Se o campo de "Mensagem" não estiver preenchido, mostrar:
        ...
        $button.addEventListener('click', function(e) {
            e.preventDefault();
            if($inputEmail.value === '' || $inputUsername.value === '' || $message.value  === '' || isValidEmail($inputEmail.value) === null) {
                ...
                if(isValidEmail($inputEmail.value) === null) {
                    alert('Entre com um email válido')
                }
            }

            if($inputEmail.value !== '' && $inputUsername.value !== '' && $message.value  !== '' && isValidEmail($inputEmail.value) !== null){
                var formulario = confirm('Tem certeza que deseja enviar formulario? ')
                formulario ? alert('Enviado com sucesso') : alert('não enviado');
            }
        }, false);

        /*
        Crie uma função chamada `isValidEmail`, que será usada na validação dox
        envio do formulário.
