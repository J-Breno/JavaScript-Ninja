(function () {
    ...
    */
    ...
    var brasil = [];
    brasil = brasil.concat(sul, suldeste);
    console.log(brasil)
    ...
    */
    var nordeste = ['Alagos', 'Bahia', 'Ceará', 'Maranhão', 'Paraíba', 'Pernambuco', 'Piauí', 'Rio Grande do Norte', 'Sergipe'];
    /*
    ...
    */
    ...
    maiorDoQue7 = brasil.every(function(item, index){
    ...
    */
    ...
    var estaIncluso = brasil.some(function(item, index) {
        return item === 'Ceará';
    })
    if(estaIncluso === true){
