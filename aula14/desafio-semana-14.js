...
*/
  ...
  console.log("\nOperation:");
  var operation = justMod2Or3.reduce(function (
    totalValorAcumulado,
    valorAtual,
    index
  ) {
    return (totalValorAcumulado + 1) * valorAtual;
  },
  0);
...
*/
  ...
  var name = ["J", "o", "ã", "o"];
  var reduceP = name.reduce(function(totalValorAcumulado,valorAtual) {
    return totalValorAcumulado + 'P' + valorAtual;
  }, ' ')
  console.log(reduceP);
  /*
...
*/
  console.log("\nInversed Name:");
  var inversedName = name.reduceRight(function(totalValorAcumulado, valorAtual) {
