...
*/
  ...
  var sub = subtraction(function(x,y) {
    return x - y;
  })
  var multiplication = calculator(8,5);
  var mult = multiplication(function(x,y) {
    return x * y;
  })
  var division = calculator(10,5);
  var div1 = division(function(x,y) {
    return x / y;
  })
  var mod = calculator(6,2);
  var mod1 = mod(function(x,y) {
    return x % y;
  })
...
*/
  ...
  console.log("O resultado da divisão é:" + div1);
  // ?

  console.log("O resto da divisão é:" + mod1);
  // ?
})();
