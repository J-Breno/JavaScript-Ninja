  ...
  "use strict";
    ...
    */
    function sum() {
        ...
        return Array.prototype.reduce.call(arguments, function(valorJuntado, valorAtual) {
            return Number(valorJuntado) + Number(valorAtual);
        })
    }
    ...
    */
    ...
    console.log(justNumbers('10dkfdk3283fdj1'))
    /*
