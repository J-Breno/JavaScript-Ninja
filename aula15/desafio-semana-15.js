(function(){
    ...
    */
    ...
    var joao = new Person('João','Breno', 19);
    var calvino = new Person('João', 'Calvino', 35);
    var lutero = new Person('Martinho', 'Lutero', 40);
    ...
    */
    ...
    console.log(calvino.getFullName());
    console.log(lutero.getFullName());
    /*
    ...
    */
    ...
    console.log(`${lutero.getFullName()} tem ${lutero.age} anos.`);
    console.log(`${calvino.getFullName()} tem ${calvino.age} anos.`)
